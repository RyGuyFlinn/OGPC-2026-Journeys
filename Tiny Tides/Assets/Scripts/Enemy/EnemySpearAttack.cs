...
public class EnemySpearAttack : MonoBehaviour
{
    public static EnemySpearAttack instance;
    ...
    void Update()
    {
        ...
        if (Retreat)
        {
            Vector3 pushDir = enemy.transform.position - player.transform.position;
        ...
        if (Charge == true)
        {
            ...
            Vector2 newPosition = Vector2.MoveTowards(enemyrb.position, oldplayerpos, 10f * Time.fixedDeltaTime);
